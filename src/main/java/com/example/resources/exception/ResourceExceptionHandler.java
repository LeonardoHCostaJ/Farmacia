...
import com.example.service.exceptions.DataIntegrityViolationException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request){
        ...
        ValidationError errors = new ValidationError(System.currentTimeMillis(),HttpStatus.BAD_REQUEST.value(), "Data Validation Violation", "Field Validation Error", request.getRequestURI());
